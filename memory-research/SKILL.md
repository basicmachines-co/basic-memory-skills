...
- **Store source URLs.** Include the URLs you consulted, either in observations or a Sources section.
- **Get approval before creating.** Present your findings and let the user decide whether to create the entity.
